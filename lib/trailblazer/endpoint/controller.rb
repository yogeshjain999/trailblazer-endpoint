  ...
  class Endpoint
    module Controller
      ...
      module DSL
        module Endpoint
          ...
          def endpoint(name, **options, &block)
            ...
            name.is_a?(Hash) ? generic_endpoint_config(**name, **options) : endpoint_config(name, **options)

            Trailblazer::Endpoint::Track.new(options[:adapter])
          end
      ...
      module InstanceMethods
        ...
        def endpoint_for(name, config_source: self)
